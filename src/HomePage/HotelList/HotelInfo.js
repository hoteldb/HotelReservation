...
function HotelInfo() {
  ...
  if (!hotelData || !hotelData.roomDetails || hotelData.roomDetails.length === 0) {
    console.log('데이터 로드 중 또는 roomDetails가 없습니다.');
    return <div>Loading...</div>;
  }
  
  console.log('API 응답 데이터:', hotelData);
  console.log('roomDetails:', hotelData.roomDetails);
